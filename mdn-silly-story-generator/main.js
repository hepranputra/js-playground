const customNameInput = document.getElementById("customname-input");
...
let insertX = ["Willy the Goblin", "Big Daddy", "Father Chrismas"];
...
function result() {
    ...
    if (document.getElementById("uk").checked) {
        ...
        const temp = Math.round(5 / 9 * (94 - 32)) + " centigrade";
        newStory = newStory.replace("300 pounds", weight);
        newStory = newStory.replace("94 fahrenheit", temp);
    }

    outputParagraph.textContent = newStory;
